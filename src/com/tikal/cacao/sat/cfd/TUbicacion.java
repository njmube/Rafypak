...
public class TUbicacion {
    ...
    public String toString() {
    	...
    	strBuilder.append(Util.regresaTextoOCadenaVacia(this.calle));
    	strBuilder.append(" ");
    	
    	if (this.noExterior != null)
    		strBuilder.append(this.noExterior);
    	
    	if (this.noInterior != null) {
    		if (this.noExterior != null)
    			strBuilder.append("-");
        	strBuilder.append(this.noInterior);
        	strBuilder.append(" ");
    	} else {
    		strBuilder.append(" ");
    	}
    	
    	strBuilder.append(Util.regresaTextoOCadenaVacia(this.colonia));
    	if (this.colonia != null)
    		strBuilder.append(" ");
    	
    	strBuilder.append(Util.regresaTextoOCadenaVacia(this.localidad));
    	if (this.colonia != null || this.localidad != null)
    		strBuilder.append(", ");
    	
    	strBuilder.append(Util.regresaTextoOCadenaVacia(this.municipio));
    	if (this.municipio != null)
    		strBuilder.append(", ");
    	
    	strBuilder.append(Util.regresaTextoOCadenaVacia(this.estado));
    	if (this.estado != null)
    		strBuilder.append(", ");
    	strBuilder.append(this.pais);
    	strBuilder.append(". ");
    	
    	if (this.codigoPostal != null)
    		strBuilder.append("C.P. ");
    	strBuilder.append(Util.regresaTextoOCadenaVacia(this.codigoPostal));
