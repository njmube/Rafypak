...
//		}
	...
	public static String marshallComprobanteConPagos(com.tikal.cacao.sat.cfd33.Comprobante c, boolean timbrado) {
		try {
			
			JAXBContext jaxbContext = JAXBContext.newInstance(com.tikal.cacao.sat.cfd33.Comprobante.class, Pagos.class, mx.gob.sat.timbrefiscaldigital.TimbreFiscalDigital.class);
			Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
		
			if(timbrado) {
				jaxbMarshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,	
						"http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd " +
							"http://www.sat.gob.mx/Pagos http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos10.xsd http://www.sat.gob.mx/TimbreFiscalDigital http://www.sat.gob.mx/sitio_internet/cfd/TimbreFiscalDigital/TimbreFiscalDigitalv11.xsd");
			}else {
				jaxbMarshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,	
				"http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd " +
