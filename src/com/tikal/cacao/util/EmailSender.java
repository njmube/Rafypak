...
//			msg.setText("Prueba de correo 2");
	...
	public void enviaFacturaBoveda(String emailReceptor, String uuid,String numfac, String fechaProgramada) {
		...
		try {
			...
			Multipart mp = new MimeMultipart();
			MimeBodyPart mbp = new MimeBodyPart();
			mbp.setContent("<h1>Informamos que el pago para su factura con uuid: "+uuid+"y numero de factura:"+numfac+" está programado para el dia: "+fechaProgramada+"</h1>","text/html");
			mp.addBodyPart(mbp);
