...
public class ObjectFactory {
    ...
    private final static QName _acuseSat_QNAME = new QName("apps.services.soap.core.views", "AcuseSat");
	private final static QName _estado_QNAME = new QName("apps.services.soap.core.views", "Estado");
	private final static QName _codigoEstatus_QNAME = new QName("apps.services.soap.core.views", "CodigoEstatus");
	private final static QName _xmlBoolean_QNAME = new QName("apps.services.soap.core.views", "xml");
	private final static QName _selloSat_QNAME = new QName("apps.services.soap.core.views", "sello_sat");
	private final static QName _error_QNAME = new QName("apps.services.soap.core.views", "error");
	private final static QName _sat_QNAME = new QName("apps.services.soap.core.views", "sat");
	private final static QName _sello_QNAME = new QName("apps.services.soap.core.views", "sello");
    /**
...
//    }
    ...
    @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "sat", scope= ValidateResult.class)
    public JAXBElement<AcuseSAT> createValidateResultAcuseSAT(AcuseSAT value) {
        return new JAXBElement<AcuseSAT>(this._acuseSat_QNAME, AcuseSAT.class, ValidateResult.class, value);
    }
    
    @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "Estado", scope= AcuseSAT.class)
    public JAXBElement<String> createValidationResultAcuseSATEstado(String value) {
        return new JAXBElement<String>(this._estado_QNAME, String.class, AcuseSAT.class, value);
    }
    
    @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "CodigoEstatus", scope= AcuseSAT.class)
    public JAXBElement<String> createValidationResultAcuseSATCodigoEstatus(String value) {
        return new JAXBElement<String>(this._codigoEstatus_QNAME, String.class, AcuseSAT.class, value);
    }
    
  @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "xml", scope= ValidateResult.class)
  public JAXBElement<Boolean> createValidationResultXml(Boolean value) {
      return new JAXBElement<Boolean>(this._xmlBoolean_QNAME, Boolean.class, ValidateResult.class, value);
  }
  
  @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "sello", scope= ValidateResult.class)
  public JAXBElement<Boolean> createValidationResultSello(Boolean value) {
      return new JAXBElement<Boolean>(this._sello_QNAME, Boolean.class, ValidateResult.class, value);
  }
  
  @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "sello_sat", scope= ValidateResult.class)
  public JAXBElement<Boolean> createValidationResultSelloSat(Boolean value) {
      return new JAXBElement<Boolean>(this._selloSat_QNAME, Boolean.class, ValidateResult.class, value);
  }
  
  @XmlElementDecl(namespace = "apps.services.soap.core.views", name = "error", scope= ValidateResult.class)
  public JAXBElement<String> createValidationResultError(String value) {
      return new JAXBElement<String>(this._error_QNAME, String.class, ValidateResult.class, value);
  }
}
