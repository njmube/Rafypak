		...
		function($rootScope, $http, $location, $q,$cookieStore) {
			this.authenticate = function(credentials, callback) {
				...
				$http.get('user', {
					...
					$cookieStore.put('username', data.usuario);
					if (data.usuario) {
						...
						$http.get("/xml/Permisos/"+ data.usuario).success(function(data) {
							$cookieStore.put('permisos', data);
						});
					} else {
